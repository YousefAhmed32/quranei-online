...
const PROGRAMS = [
  {
    ...
    number: '٠١',
    icon: '📖',
    title: 'التأسيس القرآني',
    tagline: 'رحلةٌ تبدأ من الحرف الأول',
    desc: 'مساركَ نحو القرآن يبدأ هنا؛ بتأسيسٍ صحيح وتدرّجٍ رصين يُرسّخ القواعد ويُمكّن الحرف في القلب قبل اللسان.',
    level: 'مبتدئ',
    accent: '#5e8abf',
  ...
  },
  {
    ...
    icon: 'ن',
    title: 'أحكام التجويد',
    tagline: 'إتقانٌ يُزيّن التلاوة',
    desc: 'تُدرَّس أحكام التجويد وفق منهجٍ أكاديميٍّ متدرّج، يجمع بين الأصول النظرية والتطبيق العملي المُسمَّع على يد معلّمٍ مُجاز.',
    level: 'مبتدئ — متوسط',
    accent: '#dfab70',
  ...
  },
  {
    ...
    tagline: 'حيث يُولَد الحرف الصحيح',
    desc: 'برنامجٌ معمّق لدراسة مخارج الحروف وصفاتها؛ لأنّ جمال التلاوة لا يتحقّق إلا بإخراج كلّ حرفٍ من موضعه الصحيح.',
    level: 'متوسط',
    accent: '#4a9090',
  ...
  },
  {
    ...
    tagline: 'وصيةُ النبيّ ﷺ منهجاً',
    desc: 'منهجٌ متكامل للحفظ والمراجعة، يُعنى بالضبط التجويديّ والربط بين السور، ليكون القرآن رفيقاً لا يفارق الصدر.',
  ...
  },
  {
    ...
    number: '٠٥',
    icon: '🎖',
    title: 'الإجازة القرآنية',
    tagline: 'سندٌ يتّصل بخير الأنام ﷺ',
    desc: 'للراغبين في حمل الإجازة العلمية المعتمدة برواية حفصٍ عن عاصم، بأسانيدَ موثَّقة ومتّصلة بالرسول ﷺ، يُشرف عليها علماءُ مُتقِنون.',
    level: 'متقدّم',
    accent: '#dfab70',
    glow: 'rgba(223,171,112,0.2)',
    border: 'rgba(223,171,112,0.3)',
  },
  {
    ...
    number: '٠٦',
    icon: '✦',
    title: 'التلاوة والترتيل',
    tagline: 'وَرَتِّلِ الْقُرْآنَ تَرْتِيلًا',
    desc: 'برنامجٌ لمن يرنو إلى قراءةٍ مؤثّرة تُحرّك القلوب؛ يجمع بين إتقان الأداء وتذوّق معاني الآيات وإحسان مقامات التلاوة.',
    level: 'متوسط — متقدّم',
    accent: '#5e8abf',
    glow: 'rgba(94,138,191,0.2)',
    border: 'rgba(94,138,191,0.25)',
